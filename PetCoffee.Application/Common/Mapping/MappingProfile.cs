...
public class MappingProfile : Profile
{
	public MappingProfile()
	{
		...
		CreateMap<PetCoffeeShop, PetCoffeeShopResponse>()
			.ForMember(dest => dest.HasPromotion, opt => opt.MapFrom(src => src.Promotions.Any()));
		CreateMap<PetCoffeeShop, PetCoffeeShopForCardResponse>()
			.ForMember(dest => dest.HasPromotion, opt => opt.MapFrom(src => src.Promotions.Any()));
		...
		CreateMap<Transaction, PaymentResponse>()
			...
			.ForMember(dest => dest.TransactionProducts, opt => opt.MapFrom(src => src.TransactionProducts))
