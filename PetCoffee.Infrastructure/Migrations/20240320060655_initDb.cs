	...
	public partial class initDb : Migration
	{
		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					table.PrimaryKey("PK_Invoie", x => x.Id);
					table.ForeignKey(
						name: "FK_Invoie_Account_CreatedById",
						column: x => x.CreatedById,
						principalTable: "Account",
						principalColumn: "Id");
					table.ForeignKey(
						name: "FK_Invoie_Order_ReservationId",
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						name: "FK_InvoiceProduct_Invoie_InvoiceId",
						column: x => x.InvoiceId,
						principalTable: "Invoie",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
			...
			migrationBuilder.CreateIndex(
				name: "IX_Invoie_CreatedById",
				table: "Invoie",
				column: "CreatedById");

			migrationBuilder.CreateIndex(
				name: "IX_Invoie_ReservationId",
				table: "Invoie",
